...
const Partnerstep = () => {
  return (
    <div className="bg-[#F4F4F4] py-10 h-[150vh] overflow-hidden">
      <div className="max-w-[1180px] container mx-auto relative ">
        <img
          src="/../assets/line.svg"
          alt="line"
          className="object-contain absolute z-10 left-4 top-14"
        />
        ...
        <div className="pl-[120px] flex gap-7 mt-5">
          <div className="flex justify-center items-center bg-[#F2E9E4] w-[150px] h-[150px] rounded-full z-50">
        ...
        <div className="pl-[240px] flex gap-7 mt-5">
          <div className="flex justify-center items-center bg-[#F2E9E4] w-[150px] h-[150px] rounded-full z-50">
        ...
        <div className="pl-[360px] flex gap-7 mt-5">
          <div className="flex justify-center items-center bg-[#F2E9E4] w-[150px] h-[150px] rounded-full z-50">
